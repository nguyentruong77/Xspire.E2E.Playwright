...
/// <summary>
/// Represents the Geography Level Definitions - New/Edit form page.
/// </summary>
public class GeographyLevelDefinitionsNewPage
{
    private readonly IPage _page;
    private readonly PlaywrightSettings _settings;

    public GeographyLevelDefinitionsNewPage(IPage page, PlaywrightSettings settings)
    {
        _page = page;
        _settings = settings;
    }
    ...
    public async Task EnsureOnNewPageAsync()
    {
        ...
        await Assertions.Expect(_page).ToHaveURLAsync(
            new System.Text.RegularExpressions.Regex(
                ".*SharedInformation/GeographyLevelDefinitions/00000000-0000-0000-0000-000000000000.*"));
    }
    ...
    /// <summary>
    /// Country combobox wrapper (provided by user).
    /// </summary>
    ...
    private async Task SelectFirstCountryAsync()
    {
        ...
        await input.First.FillAsync(GeographyLevelDefinitionsTestData.CreateValid.CountrySearchText);
    ...
    /// <summary>
    /// Fill required fields for create/edit success.
    /// </summary>
